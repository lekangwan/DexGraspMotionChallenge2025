...
EXP=$ROOT/retarget_research/outputs/reboot_slip_feedback_cal50_v2
...
generate_hand() {
  ...
  "$PYTHON" -u "$METHOD" \
    ...
    --batch-size 10 --slip-threshold 0.003 --max-recoverable-slip 0.03 \
    --require-existing-contact --min-contact-impulse 0.02 \
    --tighten-per-frame 0.01 --max-residual 0.15 --score-margin 1.0 \
